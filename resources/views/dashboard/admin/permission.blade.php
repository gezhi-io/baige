<x-dashboard-layout>
    ...
    <div class="my-2 flex sm:flex-row flex-col">
        <div class="flex flex-row mb-1 sm:mb-0">
            <div class="relative">
                <select id="number"
                    class="h-full rounded border block w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500  appearance-none">
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="inline-block min-w-full rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="px-5 py-5 bg-white border-t">
                        {{ $permissions->appends(Request::except('page'))->onEachSide(1)->links('vendor.pagination.tailwind',['number'=>$number]) }}
                    </div>
                </div>
            </div>
        </div>
